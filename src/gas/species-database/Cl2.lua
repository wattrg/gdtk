...
db.Cl2.sigma = {
   ...
   reference = 'Cl2 hard sphere radius (copied from Eilmer 3)'
}
db.Cl2.epsilon = {
   value = 316.000,
   units = 'K',
   description = 'Lennar-Jones potential distance.',
   reference = 'Svehla (1962), NASA Technical Report R-132 (copied from Eilmer 3, converted to K)'
}
db.Cl2.r_eq = {
   value = 1.987e-10,
   units = 'm',
   description = 'equilibrium intermolecular distance',
   reference = 'Scehla (1962), NASA Technical Report R-132'
}
